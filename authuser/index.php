...
if (isset($_POST['submitlogin'])) {
    ...
    $cekUser = mysqli_query($koneksi, "SELECT * FROM user WHERE username = '$nama' AND password = '$pass' ");
    // echo mysqli_num_rows($cekUser);die;
    if (mysqli_num_rows($cekUser) > 0) {
        ...
        if ($data['level'] == 'user') {
            ...
            $_SESSION['level']      = "user";
            header("location: ../home/index.php?pesan=sukses");
        }
